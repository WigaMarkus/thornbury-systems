...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen">
      <header className="no-print sticky top-0 z-10 flex items-center gap-1 overflow-x-auto bg-navy-900 px-3 py-2 text-slate-300 md:hidden">
        <div className="mr-2 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-brand-500/20 text-brand-500">
      ...
      <aside className="no-print fixed inset-y-0 left-0 hidden w-56 bg-navy-900 text-slate-300 md:block">
